        ...
        <div className="flex flex-col lg:flex-row gap-x-10">
          <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{once: false, amount:0.7}} className="flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0">
            ...
            <div>
              ...
              <p className="max-w-sm mb-16"> In all of these i have resposibilities for UI/UX and give solution for customer requirements. I also work as a customer support</p>
